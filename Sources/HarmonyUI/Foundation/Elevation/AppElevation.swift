...
public struct DefaultAppElevation: AppElevation {
    ...
    public init(
        level1: ElevationStyle = ElevationStyle(color: .black.opacity(0.1), radius: 2, x: 0, y: 1),
        level2: ElevationStyle = ElevationStyle(color: .black.opacity(0.15), radius: 4, x: 0, y: 2),
        level3: ElevationStyle = ElevationStyle(color: .black.opacity(0.2), radius: 6, x: 0, y: 4),
        level4: ElevationStyle = ElevationStyle(color: .black.opacity(0.25), radius: 8, x: 0, y: 6)
    ) {
        self.level1 = level1
        self.level2 = level2
        self.level3 = level3
